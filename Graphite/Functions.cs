...
namespace ahd.Graphite.Functions
{
	...
	/// </code>
	/// </summary>
	public partial class ConstantLineSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Takes a float F.
		/// <para>
		...
		public ConstantLineSeriesList(double value)
			: base("constantLine", value.ToString("r", CultureInfo.InvariantCulture))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class EventsSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Returns the number of events at this point in time. Usable with
		/// drawAsInfinite.
		...
		/// </para>
		/// </summary>
		public EventsSeriesList(params string[] tags)
			: base("events", tags.Select(SingleQuote).ToArray())
		{
		}
		...
		/// </para>
		/// </summary>
		public EventsSeriesList(string tags)
			: base("events", SingleQuote(tags))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class IdentitySeriesList : SeriesListFunction
	{
		/// <summary>
		/// Identity function:
		/// Returns datapoints where the value equals the timestamp of the datapoint.
		...
		public IdentitySeriesList(string name)
			: base("identity", SingleQuote(name))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class RandomWalkSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: randomWalk()
		/// <para>
		...
		/// </para>
		/// </summary>
		public RandomWalkSeriesList(string name, int step = 60)
			: base("randomWalk", SingleQuote(name), step)
		{
		}
		...
		/// </para>
		/// </summary>
		public RandomWalkSeriesList(string name)
			: base("randomWalk", SingleQuote(name))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class RandomWalkFunctionSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: randomWalk()
		/// <para>
		...
		/// </para>
		/// </summary>
		public RandomWalkFunctionSeriesList(string name, int step = 60)
			: base("randomWalkFunction", SingleQuote(name), step)
		{
		}
		...
		/// </para>
		/// </summary>
		public RandomWalkFunctionSeriesList(string name)
			: base("randomWalkFunction", SingleQuote(name))
		{
		}
	}
	...
	public partial class ReduceSeriesList : SeriesListFunction
	{
		...
		public ReduceSeriesList(SeriesListBase seriesLists, string reduceFunction, uint reduceNode, params string[] reduceMatchers)
			: base("reduce", Merge(SingleQuote(reduceFunction), Merge(reduceNode, reduceMatchers.Select(SingleQuote).ToArray())))
		{
		}
	}
	...
	public partial class ReduceSeriesSeriesList : SeriesListFunction
	{
		...
		public ReduceSeriesSeriesList(SeriesListBase seriesLists, string reduceFunction, uint reduceNode, params string[] reduceMatchers)
			: base("reduceSeries", Merge(SingleQuote(reduceFunction), Merge(reduceNode, reduceMatchers.Select(SingleQuote).ToArray())))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class SeriesByTagSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Returns a SeriesList of series matching all the specified tag expressions.
		/// <para>
		...
		/// </para>
		/// </summary>
		public SeriesByTagSeriesList(params string[] tagExpressions)
			: base("seriesByTag", tagExpressions.Select(SingleQuote).ToArray())
		{
		}
		...
		/// </para>
		/// </summary>
		public SeriesByTagSeriesList(string tagExpressions)
			: base("seriesByTag", SingleQuote(tagExpressions))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class SinSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: sin()
		/// <para>
		...
		/// </para>
		/// </summary>
		public SinSeriesList(string name, int amplitude = 1, int step = 60)
			: base("sin", SingleQuote(name), amplitude, step)
		{
		}
		...
		/// </para>
		/// </summary>
		public SinSeriesList(string name, int amplitude = 1)
			: base("sin", SingleQuote(name), amplitude)
		{
		}
		...
		/// </para>
		/// </summary>
		public SinSeriesList(string name)
			: base("sin", SingleQuote(name))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class SinFunctionSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: sin()
		/// <para>
		...
		/// </para>
		/// </summary>
		public SinFunctionSeriesList(string name, int amplitude = 1, int step = 60)
			: base("sinFunction", SingleQuote(name), amplitude, step)
		{
		}
		...
		/// </para>
		/// </summary>
		public SinFunctionSeriesList(string name, int amplitude = 1)
			: base("sinFunction", SingleQuote(name), amplitude)
		{
		}
		...
		/// </para>
		/// </summary>
		public SinFunctionSeriesList(string name)
			: base("sinFunction", SingleQuote(name))
		{
		}
	}
	...
	/// </code>
	/// </summary>
	public partial class ThresholdSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Takes a float F, followed by a label (in double quotes) and a color.
		/// (See ``bgcolor`` in the :doc:`Render API &lt;render_api&gt;` for valid color names &amp; formats.)
		...
		/// </code>
		/// </summary>
		public ThresholdSeriesList(double value, string label = null, string color = null)
			: base("threshold", value.ToString("r", CultureInfo.InvariantCulture), SingleQuote(label), SingleQuote(color))
		{
		}
		...
		/// </code>
		/// </summary>
		public ThresholdSeriesList(double value, string label = null)
			: base("threshold", value.ToString("r", CultureInfo.InvariantCulture), SingleQuote(label))
		{
		}
		...
		/// </code>
		/// </summary>
		public ThresholdSeriesList(double value)
			: base("threshold", value.ToString("r", CultureInfo.InvariantCulture))
		{
		}
	}
	...
	/// </para>
	/// </summary>
	public partial class TimeSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: time()
		/// <para>
		...
		/// </para>
		/// </summary>
		public TimeSeriesList(string name, int step = 60)
			: base("time", SingleQuote(name), step)
		{
		}
	...
	/// </para>
	/// </summary>
	public partial class TimeFunctionSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Short Alias: time()
		/// <para>
		...
		/// </para>
		/// </summary>
		public TimeFunctionSeriesList(string name, int step = 60)
			: base("timeFunction", SingleQuote(name), step)
		{
		}
		...
		/// </para>
		/// </summary>
		public TimeFunctionSeriesList(string name)
			: base("timeFunction", SingleQuote(name))
		{
		}
	}
	...
	/// </code>
	/// </summary>
	public partial class VerticalLineSeriesList : SeriesListFunction
	{
		/// <summary>
		/// Takes a timestamp string ts.
		/// <para>
		...
		/// </code>
		/// </summary>
		public VerticalLineSeriesList(string ts, string label = null, string color = null)
			: base("verticalLine", SingleQuote(ts), SingleQuote(label), SingleQuote(color))
		{
		}
		...
		/// </code>
		/// </summary>
		public VerticalLineSeriesList(string ts, string label = null)
			: base("verticalLine", SingleQuote(ts), SingleQuote(label))
		{
		}
		...
		/// </code>
		/// </summary>
		public VerticalLineSeriesList(string ts)
			: base("verticalLine", SingleQuote(ts))
		{
		}
	}
}
